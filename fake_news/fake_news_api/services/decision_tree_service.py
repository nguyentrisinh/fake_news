...
class DecisionTreeServices(BaseService):
    # get base_dir
    ...
    def __init__(self):
        super(DecisionTreeServices, self).__init__()
    ...
    # ---------------------- Function for Decision Tree Api -------------------------
    ...
    def decision_tree_classify_api(self, details):
        # Get training data
    ...
    def decision_tree_classify_test(self):
        # ----------------- Training models -----------------------------
        # Get all News exclude 10 first news
        training_news_query_set = NewsDetail.objects.filter(Q(category='Chinh tri') | Q(category='Suc khoe'))[10:]
        ...
        # End process Decision Tree algorithm
